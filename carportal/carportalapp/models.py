...
def insertinaddProductmethodUser(product_name,product_price,product_description,product_quantity,product_location,product_model,manufacturing_date,product_condition,product_color,product_url,user_id):
	cursor = connection.cursor()
	sql = ("insert into product(product_name,product_price,product_description,product_quantity,product_location,product_model,manufacturing_date,product_condition,product_color,product_url,created_by) values ('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')" % (product_name,product_price,product_description,product_quantity,product_location,product_model,manufacturing_date,product_condition,product_color,product_url,user_id))
	cursor.execute(sql)
	connection.close()
